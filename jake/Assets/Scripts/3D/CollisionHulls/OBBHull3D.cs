...
public class OBBHull3D : CollisionHull3D
{
    ...
    {
        return new Vector3(m_WorldToObjectTransform.m00, m_WorldToObjectTransform.m01, m_WorldToObjectTransform.m02);
    }
    public Vector3 getYNormal()
    {
        return new Vector3(m_WorldToObjectTransform.m10, m_WorldToObjectTransform.m11, m_WorldToObjectTransform.m12);
    }

    public Vector3 getZNormal()
    {
        return new Vector3(m_WorldToObjectTransform.m20, m_WorldToObjectTransform.m21, m_WorldToObjectTransform.m22);
    }

    public Vector3[] GetVertexs()
    {
        Vector3[] verts = new Vector3[8];
        verts[0] = m_Rotation * new Vector3(m_HalfLength.x, m_HalfLength.y, m_HalfLength.z); //+++
        verts[1] = m_Rotation * new Vector3(-m_HalfLength.x, m_HalfLength.y, m_HalfLength.z); //-++
        verts[2] = m_Rotation * new Vector3(m_HalfLength.x, -m_HalfLength.y, m_HalfLength.z); //+-+
        verts[3] = m_Rotation * new Vector3(m_HalfLength.x, m_HalfLength.y, -m_HalfLength.z); //++-
        verts[4] = m_Rotation * new Vector3(m_HalfLength.x, -m_HalfLength.y, -m_HalfLength.z); //+--
        verts[5] = m_Rotation * new Vector3(-m_HalfLength.x, -m_HalfLength.y, m_HalfLength.z); //--+
        verts[6] = m_Rotation * new Vector3(-m_HalfLength.x, m_HalfLength.y, -m_HalfLength.z); //-+-
        verts[7] = m_Rotation * new Vector3(-m_HalfLength.x, -m_HalfLength.y, -m_HalfLength.z); //---
        return verts;
    }
    ...
    public void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(m_Position, m_HalfLength * 2.0f);
